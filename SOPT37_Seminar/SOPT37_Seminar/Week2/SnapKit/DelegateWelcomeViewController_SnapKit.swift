//
//  DelegateWelcomeViewController_SnapKit.swift
//  SOPT37_Seminar
//
...
protocol WelcomeReloginDelegateSnapKit: AnyObject {
    func retryLogin(_ viewController: UIViewController, didTapReloginWith message: String)
}

public final class DelegateWelcomeViewControllerSnapKit: UIViewController {
    
    // MARK: - Delegate & State
    public var id: String?
    weak var delegate: WelcomeReloginDelegateSnapKit?
    ...
    init(id: String? = nil, delegate: WelcomeReloginDelegateSnapKit? = nil) {
        self.id = id
